...
import { View, Text, Button, Platform, Image, ActivityIndicator } from "react-native";
...
const ImageUpload = () => {
    ...
    const uploadImage = async () => {
        ...
        try {
            const response = await dao.postImage(formData);
            ...
            {image && (
                <View>
                    ...
                    <Button title="Upload image" onPress={() => uploadImage()} />
                        ...
                        {uploadError && (
                            <Text style={styles.text}>{uploadError}</Text>
                        )}
                        {responseImageUrl && (
                            <View>
                                <Text style={styles.text}>Image URL:</Text>
                                <Text style={styles.text}>{responseImageUrl}</Text>
                                <Image source={{ uri: responseImageUrl }} style={styles.thumbnail} />
                            </View>
                        )}
                </View>
            )}
